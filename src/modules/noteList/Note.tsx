...
export function Note({ heading = "Untitled", thumbnailUrl, children }: NoteProps) {
  return (
    <li className="flex items-center gap-2 overflow-hidden max-h-32 px-8 py-4 -ml-8 border border-zinc-900 hover:bg-zinc-900 hover:border-zinc-700 transition-colors cursor-pointer">
